...
import io.choerodon.gateway.helper.api.service.impl.GetUserDetailsServiceImpl
...
class GetUserDetailsServiceSpec extends Specification {
    ...
    def '测试getUserDetails方法'() {
        ...
        def getUserDetailsService = new GetUserDetailsServiceImpl(new MockOkRestTemplate(), new HelperProperties())
        ...
        getUserDetailsService.setRestTemplate(new MockInValidTokenRestTemplate())
        ...
        getUserDetailsService.setRestTemplate(new MockExpiredTokenRestTemplate())
